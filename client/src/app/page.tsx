      ...
      <main style={{ paddingBottom: "4rem" }}>
        ...
        >
          ...
          <span
            ...
            className="text-sm font-black text-gray-400 tracking-[0.2em] uppercase"
          >
            [ Fase de Grupos ]
          </span>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mt-6 max-w-8xl mx-auto px-6 md:px-20 lg:px-32 justify-items-center">
          {partidos.map((partido) => {
            ...
            return (
              <div key={partido.id} className="flex flex-col mb-10 max-w-xl mx-auto w-[92%]">
                ...
                <div className="bg-[#1a2233] border border-gray-700 rounded-none flex flex-col transition-all shadow-lg overflow-hidden">
                  <div className="flex flex-col justify-between h-full">
                    ...
                    <div className="flex justify-center mt-2">
                      <Link href={`/entradas?partido_id=${partido.id}`} className="w-[100%]">
                        <button
                          type="button"
                          className="w-full h-13 bg-white hover:bg-gray-200 text-black font-bold py-8 rounded-none transition-all active:scale-[0.98] shadow-md text-base"
                        >
                          CONSEGUÍ TU ENTRADA
                        </button>
                      </Link>
